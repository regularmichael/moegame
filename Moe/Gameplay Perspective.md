Here are some options to consider for gameplay perspective(s) -one doesn't have to be decided for full series.

Judging should be based on:
* How well it supports the narrative
* How well it supports the horror goal
* How well it supports the investigative gameplay
* How well it supports the combat/magic gameplay
* How well it supports controlling Moe
* How well it supports controlling Midnight??

# **Perspective 1: Third person, over the shoulder**

*In the style of:* RE Remakes, Alan Wake 2, Silent Hill 2 Remake, Hellblade
![[Pasted image 20241220212758.png]]
